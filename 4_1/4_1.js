...
var Bingo = /** @class */ (function () {
    ...
    Bingo.prototype.log = function () {
        this.content.forEach(function (grid) {
            console.log(grid);
            grid.content.forEach(function (line) {
                console.log(line);
            });
        });
    };
    Bingo.prototype.play = function (draw) {
        ...
        draw.forEach(function (d) {
            if (!gridFinishedID) {
                _this.content.forEach(function (grid) {
                    ...
                    if (!gridFinishedID && (linesComplete || columnsComplete)) {
                        gridFinishedID = grid.id;
                        lastDraw = d;
                        return;
                    }
                });
        ...
        var sumUnmarkedNumbers = this.content[gridFinishedID].sumUnmarkedNumbers();
